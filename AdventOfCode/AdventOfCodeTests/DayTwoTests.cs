...
namespace AdventOfCodeTests
{
    ...
    public class DayTwoTests
    {
        ...
        [TestMethod]
        public void PartOneExampleOneTest()
        {
            string row = "5;1;9;5";
            int returnValue = _dayTwo.DifferenceBetweenMinAndMaxOfRow(row);
            Assert.AreEqual(8, returnValue);
        }

        [TestMethod]
        public void PartOneExmpleTwoTest()
        {
            string row = "7;5;3";
            int returnValue = _dayTwo.DifferenceBetweenMinAndMaxOfRow(row);
        ...
        [TestMethod]
        public void PartOneExmpleThreeTest()
        {
            string row = "2;4;6;8";
            int returnValue = _dayTwo.DifferenceBetweenMinAndMaxOfRow(row);
        ...
        public void PartOneActualInputTest()
        {
            ...
            int returnValue = _dayTwo.SumOfRows(rows);
            Assert.AreEqual(53978, returnValue);

            Assert.AreEqual(0, 8 % 2);
        }

        [TestMethod]
        public void PartTwoExampleOneTest()
        {
            string row = "5;9;2;8";
            int returnValue = _dayTwo.GetDeviseableNumber(row);
            Assert.AreEqual(4, returnValue);
        }

        [TestMethod]
        public void PartTwoExamplTwoTest()
        {
            string row = "9;4;7;3";
            int returnValue = _dayTwo.GetDeviseableNumber(row);
        ...
        [TestMethod]
        public void PartTwoExampleThreeTest()
        {
            string row = "3;8;6;5";
            int returnValue = _dayTwo.GetDeviseableNumber(row);
        ...
        public void PartTwoActualInputTest()
        {
            ...
            int returnValue = _dayTwo.SumOfRowsPartTwo(rows);
            Assert.AreEqual(314, returnValue);
        }
    }
}
